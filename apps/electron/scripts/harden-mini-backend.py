...
WINDOWS_EXTERNAL_STORAGE_ROOT = _resolve_env_path(
    "MINI_BACKEND_EXTERNAL_STORAGE_ROOT",
    Path(r"D:\KomaStudio\koma-studio-storage"),
)
HARDENED_STORAGE_DIR = _resolve_env_path(
    "MINI_BACKEND_HARDENED_STORAGE_DIR",
    WINDOWS_EXTERNAL_STORAGE_ROOT / "mini-backend-hardened",
)
...
def windows_external_storage_available() -> bool:
    if (
        ...
        return False
    return platform.system() == "Windows" and WINDOWS_EXTERNAL_STORAGE_ROOT.exists()
