...
interface SegmentTextModelControlProps {
  value: string;
...
export const SegmentTextModelControl = ({
  value,
  options,
  selectedModel,
  statusText,
  ...
  return (
    <div className="koma-stage-config">
      <div className={styles.headerRow}>
        <label className="koma-field__label">{t("aio.stage.segmentText")}</label>
...
export default SegmentTextModelControl;
